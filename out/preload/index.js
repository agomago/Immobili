...
electron.contextBridge.exposeInMainWorld("api", {
	utenze: {
		...
		getByTipo: (immobile_id, tipo) => electron.ipcRenderer.invoke("utenze:getByTipo", {
			immobile_id,
			tipo
		}),
	...
	immobili: {
		...
		update: (id, data) => electron.ipcRenderer.invoke("immobili:update", {
			id,
			data
		}),
	...
	unita: {
		...
		update: (id, data) => electron.ipcRenderer.invoke("unita:update", {
			id,
			data
		}),
	...
	inquilini: {
		...
		update: (id, data) => electron.ipcRenderer.invoke("inquilini:update", {
			id,
			data
		}),
		delete: (id) => electron.ipcRenderer.invoke("inquilini:delete", id),
		uploadFoto: (filePath, inquilino_id) => electron.ipcRenderer.invoke("inquilini:uploadFoto", {
			filePath,
			inquilino_id
		}),
	...
	contratti: {
		...
		update: (id, data) => electron.ipcRenderer.invoke("contratti:update", {
			id,
			data
		}),
	...
	pagamentiAffitto: {
		...
		pagaRata: (id, data) => electron.ipcRenderer.invoke("pagamentiAffitto:pagaRata", {
			id,
			data
		}),
		create: (data) => electron.ipcRenderer.invoke("pagamentiAffitto:create", data)
	},
	categorie: { getAll: () => electron.ipcRenderer.invoke("categorie:getAll") },
	spese: {
		...
		update: (id, data) => electron.ipcRenderer.invoke("spese:update", {
			id,
			data
		}),
		pagaSpesa: (id, data) => electron.ipcRenderer.invoke("spese:pagaSpesa", {
			id,
			data
		}),
	...
	documenti: {
		...
		elaboraOcr: (doc_id, percorso_file) => electron.ipcRenderer.invoke("documenti:elaboraOcr", {
			doc_id,
			percorso_file
		}),
	...
	dashboard: { getSummary: () => electron.ipcRenderer.invoke("dashboard:getSummary") },
	report: {
		excel: (params) => electron.ipcRenderer.invoke("report:excel", params),
		pdf: (params) => electron.ipcRenderer.invoke("report:pdf", params),
		mensiliPerCategoria: (immobile_id, anno) => electron.ipcRenderer.invoke("report:mensiliPerCategoria", {
			immobile_id,
			anno
		}),
		totaliMensili: (immobile_id, anno) => electron.ipcRenderer.invoke("report:totaliMensili", {
			immobile_id,
			anno
		})
	},
